...
import {MAXIMUM_HABITAT_RATE, MAXIMUM_LOGISTIC_RATE, MAXIMUM_MINING_RATE, MAX_VENUS_SCALE, MIN_OXYGEN_LEVEL, MIN_TEMPERATURE, MIN_VENUS_SCALE, POLITICAL_AGENDAS_MAX_ACTION_USES} from '../../../common/constants';
...
class RedsPolicy03 implements IPolicy {
  ...
  private canDecrease(game: IGame, parameter: GlobalParameter) {
    ...
    case GlobalParameter.TEMPERATURE:
      ...
      return temp > MIN_TEMPERATURE && temp !== game.globalParameterMaximums.temperature;
    case GlobalParameter.OCEANS:
      return game.canRemoveOcean();
    case GlobalParameter.OXYGEN:
      const oxygenLevel = game.getOxygenLevel();
      return oxygenLevel > MIN_OXYGEN_LEVEL && oxygenLevel !== game.globalParameterMaximums.oxygen;
